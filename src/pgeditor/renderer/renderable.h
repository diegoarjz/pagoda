...
class Renderable
{
	...
	const std::shared_ptr<MaterialNetwork>& GetMaterial() const { return m_material; }
	void SetMaterial(const std::shared_ptr<MaterialNetwork>& material) { m_material = material; }
