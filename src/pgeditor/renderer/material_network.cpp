...
const MaterialNode* MaterialNetwork::GetMaterialNode(const std::string& name) const
{
...
void MaterialNetwork::SetStageTerminalNode(ShaderStage stage, const std::string& name)
{
	switch (stage) {
