...
Viewer::Viewer(QWidget *parent)
    : QOpenGLWidget(parent), m_cameraFocus{0, 0, 0},
...
void Viewer::SetRenderingSystem(
    const renderer::RenderingSystemPtr &renderingSystem) {
...
void Viewer::mouseMoveEvent(QMouseEvent *event) {
  ...
  if (modifiers & Qt::KeyboardModifier::AltModifier) {
    ...
    m_verticalRotation =
        std::clamp<float>(m_verticalRotation + dy * 0.1f, 0.0f,
