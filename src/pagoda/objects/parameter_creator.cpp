...
std::shared_ptr<PAR_TYPE> createParameter(
  VAL_TYPE* v, const std::string& name, const std::string& label,
...
StringParameterPtr ParameterCreator::StringParameter(
...
PlaneParameterPtr ParameterCreator::PlaneParameter(
