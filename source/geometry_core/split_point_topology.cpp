...
{
	// Points
	IndexPointPairArray_t<3> points = {std::make_pair(p0.GetIndex(), m_points.Get(p0.GetIndex())),
...
SplitPointTopology::CreateFaceResult SplitPointTopology::CreateFace(const PointHandle &p0, const PointHandle &p1)
{
	// Points
	IndexPointPairArray_t<3> points = {std::make_pair(p0.GetIndex(), m_points.Get(p0.GetIndex())),
	                                   std::make_pair(p1.GetIndex(), m_points.Get(p1.GetIndex())),
                                                                    ...
                                                                    const PointHandle &p2)
{
	...
	IndexPointPairArray_t<3> points = {std::make_pair(p0.GetIndex(), m_points.Get(p0.GetIndex())),
	                                   std::make_pair(p1.GetIndex(), m_points.Get(p1.GetIndex())),
	                                   std::make_pair(p2.GetIndex(), m_points.Get(p2.GetIndex()))};
