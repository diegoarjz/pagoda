...
private:
	...
	struct HandleHasher
	{
		std::size_t operator()(const T& handle)
		{
...
public:
	...
	using SplitPointHandleSet = std::unordered_set<SplitPoint, HandleHasher<SplitPointHandle>>;
	...
	CreateFaceResult CreateFace(const PointHandle &p1, const PointHandle &p1, const PointHandle &p2);
