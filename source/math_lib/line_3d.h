...
public:
     ...
     */
    Line3D(const VectorType &point, const VectorType &normalizedDirection) : m_point(point), m_direction(normalizedDirection) {}
     ...
     */
    const VectorType& GetDirection() const { return m_direction; }
