...
def export_geometry(test):
    ...
    test.tester.file_contents.should_match("geometry_0.obj")
    test.tester.file_contents.should_match("geometry_1.obj")
    test.tester.file_contents.should_match("export_geometry.dot")
